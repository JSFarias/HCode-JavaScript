class CalcController{
    ...
    pushOperator(value) {       
        ...
        /*if(this._operation.length > 2){
            //console.log(eval(`${this._operation[0]} ${this._operation[1]} ${this._operation[2]}`));
            let result =  eval(this._operation.join(""));//eval(`${this._operation[0]} ${this._operation[1]} ${this._operation[2]}`);
