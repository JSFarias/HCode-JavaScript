class DropBoxController{
    ...
    constructor(){
        ...
        this.functionsPath = ["this.db.collection('a')"];
        this.pathBtns;
    ...
    connectToFirebase(){        
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyA-8iNGs3jvzdwIBThonzP0jDBKuMT3b1k",
            authDomain: "dropbox-clone-c75b5.firebaseapp.com",
            databaseURL: "https://dropbox-clone-c75b5.firebaseio.com",
            projectId: "dropbox-clone-c75b5",
            storageBucket: "dropbox-clone-c75b5.appspot.com",
            messagingSenderId: "687622436881",
            appId: "1:687622436881:web:927b14b1e42aa3c414d9b0"
        }    
        // Initialize Firebase
    ...
    removeFolderTask(dbRef, storageRef, folderNameHierachy){
        ...
        return new Promise((resolve, reject)=>{
            ...
            let dbFwdRef = dbRef + ".doc('"+folderNameHierachy+"').collection('"+folderNameHierachy+"')"; //reaching next folder (collection)

            let folderRef = this.getFirebaseRef(dbFwdRef);
...
// })
    initEvents(){
        ...
        this.btnRename.addEventListener('click', e=>{
            ...
            if(name){
                ...
                this.getFirebaseRef().doc(li.dataset.key).update({
                    name: name
                })
                .then(doc=>{
                    this.readFiles();
        ...
        this.inputFileEl.addEventListener('change', event=>{
            ...
            this.uploadTask(event.target.files).then(responses =>{
                ...
                /* //vindo do ajax, usando storage local
                responses.forEach(resp=>{
    ...
    getFirebaseRef(builtPathFunctions = this.functionsPath.join('.')){
    ...
    uploadTask(files){ 
        ...
        [...files].forEach(file=>{ //files ñ é um array, mas sim uma coleção, por isso usamos spread [...files]
            ...
            promises.push(new Promise((resolve, reject)=>{
                ...
                let task = fileRef.put(file, metadata);
            ...
            /* //armazenamento de servidor local
            let formData = new FormData()
    ...
    ajax(url, method = 'GET', formData = new FormData(), onprogress = function(){}, onloadstart = function(){}) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            //this.fileNameEl.textContent = file.textContent;
    ...
    uploadProgress(event, file){
        ...
        //console.log(timeSpent, timeLeft, percent, timeLeft.toLocaleString());
    }
    ...
    initEventsLi(li){ 
        li.addEventListener('dblclick', e=>{
            ...
            switch(file.type){
                ...
                this.functionsPath.push("doc('"+file.name+"').collection('"+file.name+"')");
                this.openFolder();
                break;
