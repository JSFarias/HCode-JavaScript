...
export class WhatsAppController{
                                ...
                                <div class="_1AwDx">
                                    <div class="_itDl">
                                        ...
                                        <span class="_2_LEW last-message">
                                            ...
                                            <span dir="ltr" class="_1wjpf _3NFp9">${contact.lasMessage}</span>
                                            <div class="_3Bxar">
                                                <span>
                                                    <div class="_15G96">
    ...
    initEvents(){
        ...
        //start contact msg list
        this.el.contactsMessagesList.querySelectorAll('.contact-item').forEach((item, index)=>{
            item.on('click', e=>{
                this.el.home.hide();
                this.el.main.css({
                    display: 'flex'
        ...
        this.el.btnSendPicture.on('click', e=>{       
            ...
            let regex = /^data:(.+);base64,(.*)$/; //ou new RegExp()
            ...
            if(file.type === 'application/pdf'){
                ...
                Base64.toFile(base64).then(filePreview => {
                    ...
                    Message.sendDocument(
                        this._activeContact.chatId, this._user.email, file, filePreview, this.el.infoPanelDocumentPreview.innerHTML);
                ...
                Message.sendDocument(
                    this._activeContact.chatId, this._user.email, file);
