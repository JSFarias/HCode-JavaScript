...
export class Message extends Model{
    ...
    set timeStamp(value) {return this.data_timeStamp = value; }
                        ...
                        <div class="_2jfIu">
                            <div class="_2cfqh">
                                <div class="_1QMEq _1kZiz fS1bA">
                                    ...
                                    <div class="_1_Gu6">
                                        <div class="message-audio-duration">${this.duration}</div>
                                        <div class="_1sLSi">
    ...
    static sendAudio(chatId, from, file, metadata, photo){
        ...
        return Message.send(chatId, from, 'audio', '').then(msgRef =>{
            ...
            Message.uploadFile(file, from).then(downloadURL =>{
    ...
    static sendContact(chatId, from, contact){
        ...
        Message.send(chatId, from, 'contact', contact).then(msg=>{
        ...
        Message.send(chatId, from, 'document', '').then(msgRef => {            
            ...
            Message.uploadFile(file, from).then(downloadURL=>{                
                ...
                if(filePreview){
                    ...
                    Message.uploadFile(filePreview, from).then(downloadURL2=>{                
